...
class Fragment$CalendarEventWithEntries {
  ...
  factory Fragment$CalendarEventWithEntries.fromJson(
    ...
    return Fragment$CalendarEventWithEntries(
      id: (l$id as String),
...
abstract class CopyWith$Fragment$CalendarEventWithEntries<TRes> {
  factory CopyWith$Fragment$CalendarEventWithEntries(
    Fragment$CalendarEventWithEntries instance,
    TRes Function(Fragment$CalendarEventWithEntries) then,
  ) = _CopyWithImpl$Fragment$CalendarEventWithEntries;

  factory CopyWith$Fragment$CalendarEventWithEntries.stub(TRes res) =
      _CopyWithStubImpl$Fragment$CalendarEventWithEntries;
...
class _CopyWithImpl$Fragment$CalendarEventWithEntries<TRes>
  ...
  final TRes Function(Fragment$CalendarEventWithEntries) _then;
...
class _CopyWithStubImpl$Fragment$CalendarEventWithEntries<TRes>
    implements CopyWith$Fragment$CalendarEventWithEntries<TRes> {
  _CopyWithStubImpl$Fragment$CalendarEventWithEntries(this._res);
...
extension ClientExtension$Fragment$CalendarEventWithEntries
  ...
  void writeFragment$CalendarEventWithEntries({
  ...
  Fragment$CalendarEventWithEntries? readFragment$CalendarEventWithEntries({
    ...
    return result == null
        ? null
        : Fragment$CalendarEventWithEntries.fromJson(result);
  }
}
...
class Query$GetEvent {
  ...
  final Fragment$CalendarEventWithEntries? event;
...
class Variables$Query$ListEvents {
  ...
  int get hashCode {
    final l$from = from;
    return Object.hashAll([_$data.containsKey('from') ? l$from : const {}]);
  }
}

abstract class CopyWith$Variables$Query$ListEvents<TRes> {
  factory CopyWith$Variables$Query$ListEvents(
    Variables$Query$ListEvents instance,
    TRes Function(Variables$Query$ListEvents) then,
  ) = _CopyWithImpl$Variables$Query$ListEvents;

  factory CopyWith$Variables$Query$ListEvents.stub(TRes res) =
      _CopyWithStubImpl$Variables$Query$ListEvents;

  TRes call({String? from});
}
...
class _CopyWithImpl$Variables$Query$ListEvents<TRes>
  ...
  final TRes Function(Variables$Query$ListEvents) _then;
...
class _CopyWithStubImpl$Variables$Query$ListEvents<TRes>
    implements CopyWith$Variables$Query$ListEvents<TRes> {
  _CopyWithStubImpl$Variables$Query$ListEvents(this._res);

  TRes _res;

  call({String? from}) => _res;
}
...
class FetchMoreOptions$Query$ListEvents extends graphql.FetchMoreOptions {
  FetchMoreOptions$Query$ListEvents({
    required graphql.UpdateQuery updateQuery,
    Variables$Query$ListEvents? variables,
  }) : super(
          updateQuery: updateQuery,
