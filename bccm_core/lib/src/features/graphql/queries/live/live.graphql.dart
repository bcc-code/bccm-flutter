...
class Query$GetLive {
  Query$GetLive({required this.live, this.$__typename = 'QueryRoot'});
  ...
  int get hashCode {
    final l$live = live;
    final l$$__typename = $__typename;
    return Object.hashAll([l$live, l$$__typename]);
  }
...
extension UtilityExtension$Query$GetLive on Query$GetLive {
  CopyWith$Query$GetLive<Query$GetLive> get copyWith =>
      CopyWith$Query$GetLive(this, (i) => i);
}
...
class _CopyWithImpl$Query$GetLive<TRes>
  ...
  TRes call({Object? live = _undefined, Object? $__typename = _undefined}) =>
      _then(
        Query$GetLive(
...
class _CopyWithStubImpl$Query$GetLive<TRes>
  ...
  call({Query$GetLive$live? live, String? $__typename}) => _res;

  CopyWith$Query$GetLive$live<TRes> get live =>
      CopyWith$Query$GetLive$live.stub(_res);
}

const documentNodeQueryGetLive = DocumentNode(
  definitions: [
...
class FetchMoreOptions$Query$GetLive extends graphql.FetchMoreOptions {
  FetchMoreOptions$Query$GetLive({required graphql.UpdateQuery updateQuery})
    : super(updateQuery: updateQuery, document: documentNodeQueryGetLive);
}
...
extension ClientExtension$Query$GetLive on graphql.GraphQLClient {
  ...
  ]) async => await this.query(options ?? Options$Query$GetLive());
...
class Query$GetLive$live {
  ...
  int get hashCode {
    ...
    final l$expiresAt = expiresAt;
    final l$$__typename = $__typename;
    return Object.hashAll([l$isOnline, l$url, l$expiresAt, l$$__typename]);
  }
...
extension UtilityExtension$Query$GetLive$live on Query$GetLive$live {
  CopyWith$Query$GetLive$live<Query$GetLive$live> get copyWith =>
      CopyWith$Query$GetLive$live(this, (i) => i);
}
...
class _CopyWithImpl$Query$GetLive$live<TRes>
  ...
  _CopyWithImpl$Query$GetLive$live(this._instance, this._then);
...
class _CopyWithStubImpl$Query$GetLive$live<TRes>
  ...
  call({bool? isOnline, String? url, String? expiresAt, String? $__typename}) =>
      _res;
}
