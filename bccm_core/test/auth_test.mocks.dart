...
class _FakeDeviceTokenRequestResponse_10 extends _i1.SmartFake
  ...
  _FakeDeviceTokenRequestResponse_10(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeCredentials_11 extends _i1.SmartFake implements _i4.Credentials {
  _FakeCredentials_11(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockFlutterAppAuth extends _i1.Mock implements _i5.FlutterAppAuth {
  ...
  _i6.Future<_i2.AuthorizationTokenResponse> authorizeAndExchangeCode(
    ...
    returnValueForMissingStub: _i6.Future<_i2.AuthorizationTokenResponse>.value(
      _FakeAuthorizationTokenResponse_0(
        this,
        Invocation.method(#authorizeAndExchangeCode, [request]),
      ),
  ...
  _i6.Future<_i2.TokenResponse> token(_i2.TokenRequest? request) =>
      (super.noSuchMethod(
        ...
        returnValue: _i6.Future<_i2.TokenResponse>.value(
          _FakeTokenResponse_2(this, Invocation.method(#token, [request])),
        ),
        returnValueForMissingStub: _i6.Future<_i2.TokenResponse>.value(
          _FakeTokenResponse_2(this, Invocation.method(#token, [request])),
        ),
  ...
  _i6.Future<_i2.EndSessionResponse> endSession(
    ...
    returnValue: _i6.Future<_i2.EndSessionResponse>.value(
      _FakeEndSessionResponse_3(
        this,
        Invocation.method(#endSession, [request]),
      ),
    ),
    returnValueForMissingStub: _i6.Future<_i2.EndSessionResponse>.value(
      _FakeEndSessionResponse_3(
        this,
        Invocation.method(#endSession, [request]),
      ),
...
class MockFlutterSecureStorage extends _i1.Mock
  ...
  _i3.AndroidOptions get aOptions => (super.noSuchMethod(
    ...
    returnValue: _FakeAndroidOptions_5(this, Invocation.getter(#aOptions)),
  ...
  _i3.LinuxOptions get lOptions => (super.noSuchMethod(
    ...
    returnValue: _FakeLinuxOptions_6(this, Invocation.getter(#lOptions)),
  ...
  _i3.WindowsOptions get wOptions => (super.noSuchMethod(
    ...
    returnValue: _FakeWindowsOptions_7(this, Invocation.getter(#wOptions)),
  ...
  _i3.WebOptions get webOptions => (super.noSuchMethod(
    ...
    returnValue: _FakeWebOptions_8(this, Invocation.getter(#webOptions)),
...
class MockAuth0Api extends _i1.Mock implements _i4.Auth0Api {
  ...
  String get domain => (super.noSuchMethod(
    ...
    returnValue: _i8.dummyValue<String>(this, Invocation.getter(#domain)),
  ...
  String get clientId => (super.noSuchMethod(
    ...
    returnValue: _i8.dummyValue<String>(this, Invocation.getter(#clientId)),
    returnValueForMissingStub: _i8.dummyValue<String>(
      this,
      Invocation.getter(#clientId),
    ),
  ...
  String get audience => (super.noSuchMethod(
    ...
    returnValue: _i8.dummyValue<String>(this, Invocation.getter(#audience)),
    returnValueForMissingStub: _i8.dummyValue<String>(
      this,
      Invocation.getter(#audience),
    ),
  ...
  _i6.Future<_i9.Auth0SignupResponse?> signup(
    ...
    Invocation.method(#signup, [requestBody]),
  ...
  _i6.Future<_i4.DeviceTokenRequestResponse> fetchDeviceCode({
    ...
    Invocation.method(#fetchDeviceCode, [], {#scope: scope}),
    ...
    returnValueForMissingStub: _i6.Future<_i4.DeviceTokenRequestResponse>.value(
      _FakeDeviceTokenRequestResponse_10(
        this,
        Invocation.method(#fetchDeviceCode, [], {#scope: scope}),
      ),
  ...
  _i6.Future<_i4.Credentials> listenToResolve(
    ...
    Invocation.method(#listenToResolve, [deviceToken]),
    returnValue: _i6.Future<_i4.Credentials>.value(
      _FakeCredentials_11(
        this,
        Invocation.method(#listenToResolve, [deviceToken]),
      ),
    ),
    returnValueForMissingStub: _i6.Future<_i4.Credentials>.value(
      _FakeCredentials_11(
        this,
        Invocation.method(#listenToResolve, [deviceToken]),
      ),
