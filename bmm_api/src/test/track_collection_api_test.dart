...
void main() {
  final instance = Openapi().getTrackCollectionApi();
  ...
  group(TrackCollectionApi, () {
    ...
    //
    //Future trackCollectionPost({ CreateTrackCollectionCommand createTrackCollectionCommand }) async
    ...
    //Future trackCollectionTopSongsPost() async
