...
void main() {
  final instance = BmmApi().getStatisticsApi();
  ...
  group(StatisticsApi, () {
    ...
    //Future<AchievementModel> statisticsAchievementIdGet(String id, { LanguageEnum lang, String theme }) async
    test('test statisticsAchievementIdGet', () async {
      // TODO
    });
    ...
    //Future<GetFraKaareStatisticsResponse> statisticsFraKaareGet() async
    test('test statisticsFraKaareGet', () async {
      // TODO
    });
    ...
    //Future<ProjectChurchStatisticsQueryChurchStatistics> statisticsProjectChurchChurchGet(String church) async
    test('test statisticsProjectChurchChurchGet', () async {
      // TODO
    });
    ...
    //Future<ForbildePoints> statisticsV2ProjectProgressGet({ LanguageEnum lang, String theme }) async
    test('test statisticsV2ProjectProgressGet', () async {
      // TODO
    });

    //Future statisticsWatchedPost(BuiltList<StatisticsControllerWatchedEvent> statisticsControllerWatchedEvent) async
    test('test statisticsWatchedPost', () async {
      // TODO
    });
