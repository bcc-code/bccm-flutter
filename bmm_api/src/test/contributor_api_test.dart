...
void main() {
  final instance = BmmApi().getContributorApi();
  ...
  group(ContributorApi, () {
    ...
    //Future<BuiltList<ContributorModel>> contributorSearchUnpublishedTermGet(String term, { int size }) async
    test('test contributorSearchUnpublishedTermGet', () async {
      // TODO
    });
