...
part of 'process_watched_command_event.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ProcessWatchedCommandEvent extends ProcessWatchedCommandEvent {
  @override
  ...
  factory _$ProcessWatchedCommandEvent(
          [void Function(ProcessWatchedCommandEventBuilder)? updates]) =>
      (new ProcessWatchedCommandEventBuilder()..update(updates))._build();

  _$ProcessWatchedCommandEvent._(
      {this.episodeId,
      this.timestampStart,
      this.language,
      this.playbackOrigin,
  ...
  @override
  ProcessWatchedCommandEvent rebuild(
          void Function(ProcessWatchedCommandEventBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ProcessWatchedCommandEventBuilder toBuilder() =>
      new ProcessWatchedCommandEventBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ProcessWatchedCommandEvent &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ProcessWatchedCommandEvent')
...
class ProcessWatchedCommandEventBuilder
    implements
        Builder<ProcessWatchedCommandEvent, ProcessWatchedCommandEventBuilder> {
  _$ProcessWatchedCommandEvent? _$v;
  ...
  ProcessWatchedCommandEventBuilder() {
    ProcessWatchedCommandEvent._defaults(this);
  }

  ProcessWatchedCommandEventBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(ProcessWatchedCommandEvent other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ProcessWatchedCommandEvent;
  }

  @override
  void update(void Function(ProcessWatchedCommandEventBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ProcessWatchedCommandEvent build() => _build();

  _$ProcessWatchedCommandEvent _build() {
    final _$result = _$v ??
        new _$ProcessWatchedCommandEvent._(
          episodeId: episodeId,
