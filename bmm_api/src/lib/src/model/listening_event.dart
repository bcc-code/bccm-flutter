...
/// * [os] 
@BuiltValue()
abstract class ListeningEvent implements Built<ListeningEvent, ListeningEventBuilder> {
  ...
  factory ListeningEvent([void updates(ListeningEventBuilder b)]) = _$ListeningEvent;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ListeningEventBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ListeningEvent> get serializer => _$ListeningEventSerializer();
}

class _$ListeningEventSerializer implements PrimitiveSerializer<ListeningEvent> {
  @override
  final Iterable<Type> types = const [ListeningEvent, _$ListeningEvent];

  @override
  final String wireName = r'ListeningEvent';
  ...
  void _deserializeProperties(
    ...
    required ListeningEventBuilder result,
  ...
  @override
  ListeningEvent deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ListeningEventBuilder();
