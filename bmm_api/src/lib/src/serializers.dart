...
import 'package:openapi/src/model/album_year_facets_query_result.dart';
...
import 'package:openapi/src/model/document_list_i_all_document_models.dart';
...
import 'package:openapi/src/model/i_achievement_collection_or_chapter_header.dart';
...
import 'package:openapi/src/model/i_album_playlist_or_chapter_header.dart';
...
import 'package:openapi/src/model/metadata_model.dart';
...
import 'package:openapi/src/model/project_church_statistics_query_church_statistics_church.dart';
import 'package:openapi/src/model/project_rules_query_rules.dart';
import 'package:openapi/src/model/project_rules_query_rules_section.dart';
...
import 'package:openapi/src/model/store_transcription_edit_suggestions_suggestion.dart';
import 'package:openapi/src/model/streak_point.dart';
import 'package:openapi/src/model/subscription_model.dart';
...
import 'package:openapi/src/model/track_list_reference.dart';
...
import 'package:openapi/src/model/track_model_parent_meta.dart';
...
import 'package:openapi/src/model/track_model_track_contributor_type.dart';
...
@SerializersFor([
  ...
  TrackModelTrackContributorType,
  TrackModelTrackMeta,
  TrackReference,
  TrackSubtype,
...
Serializers serializers = (_$serializers.toBuilder()
      ...
      ..addBuilderFactory(
        ...
        () => ListBuilder<TrackSubtype>(),
      )
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(ListeningEvent)]),
        () => ListBuilder<ListeningEvent>(),
      )
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(StoreTranscriptionEditSuggestionsSuggestion)]),
        () => ListBuilder<StoreTranscriptionEditSuggestionsSuggestion>(),
      )
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(CreateTrackPlayedEventsCommandEvent)]),
      ...
      ..addBuilderFactory(
        ...
        () => ListBuilder<AchievementModel>(),
      )
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(IAlbumPodcastPlaylistOrSectionHeader)]),
        () => ListBuilder<IAlbumPodcastPlaylistOrSectionHeader>(),
      )
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(GetYearInReviewOverviewSlide)]),
        () => ListBuilder<GetYearInReviewOverviewSlide>(),
      )
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(AlbumYearFacetsQueryResult)]),
        () => ListBuilder<AlbumYearFacetsQueryResult>(),
      )
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(TopbarSearchQueryTopbarSearchResult)]),
      ...
      ..addBuilderFactory(
        ...
        () => ListBuilder<IAllDocumentModels>(),
      )
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(IAlbumContributorPodcastPlaylistOrTrack)]),
        () => ListBuilder<IAlbumContributorPodcastPlaylistOrTrack>(),
      )
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(ContributorModel)]),
        () => ListBuilder<ContributorModel>(),
      )
      ..addBuilderFactory(
